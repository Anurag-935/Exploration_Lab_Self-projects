...
export default function JournalGallery() {
 ...
 className="px-4 py-2 bg-brand-500 text-brand-light rounded font-medium hover:bg-brand-700 hover:text-brand-light text-sm border-2 border-brand-900 shadow-neo active:translate-x-[2px] active:translate-y-[2px] active:shadow-neo-sm font-bold "
 >
 New Note
 </button>
 )}
 ...
 {isCreating && (
 <div className="bg-brand-dark p-6 rounded-xl border-2 border-brand-900 mb-8">
 ...
 <input type="file" accept="image/*" ref={fileInputRef} onChange={handleFileSelect} className="hidden border-2 border-brand-900 border-2 border-brand-900 shadow-neo-input "
 />
 {previewUrl && (
 ...
 className="px-5 py-2.5 text-brand-light/70 hover:bg-brand-darker rounded-lg font-medium transition-colors border-2 border-brand-900 shadow-neo active:translate-x-[2px] active:translate-y-[2px] active:shadow-neo-sm font-bold "
 >
 Cancel
 </button>
 ...
 <button onClick={() => setIsCreating(true)} className="px-5 py-2 bg-brand-500 text-brand-light rounded-lg font-medium hover:bg-brand-700 hover:text-brand-light text-sm border-2 border-brand-900 shadow-neo active:translate-x-[2px] active:translate-y-[2px] active:shadow-neo-sm font-bold ">
 Write First Note
 </button>
 </div>
 ) : (
 ...
 className="bg-brand-dark rounded-xl border-2 border-brand-900 overflow-hidden hover:shadow-neo hover:border-brand-500/50 transition-all cursor-pointer flex flex-col h-72 relative group"
 >
 {/* Rating Badge */}
 {entry.rating && (
