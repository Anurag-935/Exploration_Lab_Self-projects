...
export default function RadarStats({ tasks }: Props) {
 ...
 return (
 <div className="bg-brand-dark p-6 rounded-xl border-2 border-brand-900 flex flex-col h-full">
 ...
 <PolarAngleAxis dataKey="name" tick={{ fill: '#FFFFFF', fontSize: 10, fontWeight: 600 }} />
 {/* Setting a static domain ensures the hexagon never distorts, even if some values are 0 */}
 <PolarRadiusAxis angle={30} domain={[0, stats.maxVal]} tickCount={6} tick={false} axisLine={false} />
