...
export default function ProjectsWidget({ projects, onClick }: Props) {
 ...
 <div 
 onClick={onClick}
 className="bg-brand-dark p-6 rounded-xl border-2 border-brand-900 flex flex-col justify-center cursor-pointer hover:border-brand-500/50 hover:bg-brand-darker transition-all group h-full"
 >
