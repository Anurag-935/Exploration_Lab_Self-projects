...
export default function ProjectsWidget({ projects, onClick }: Props) {
  ...
  return (
    <div 
      onClick={onClick}
      className="bg-brand-dark p-6 rounded-xl shadow-lg border border-brand-900/30 flex flex-col justify-center cursor-pointer hover:border-brand-500/50 hover:bg-brand-darker transition-all group h-full"
    >
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="flex flex-col items-center p-2 bg-brand-darker rounded border border-brand-900/20">
