...
export default function ProjectDetail({ project, onClose, onUpdated }: Props) {
 ...
 <input type="text" value={title} disabled className="w-full px-3 py-2 bg-brand-darker rounded text-brand-light/50 outline-none cursor-not-allowed border-2 border-brand-900 " />
 </div>
 <div>
 <label className="block text-sm font-medium text-brand-light/70 mb-1">Type</label>
 <input type="text" value="Short Task" disabled className="w-full px-3 py-2 bg-brand-darker rounded text-brand-light/50 outline-none cursor-not-allowed border-2 border-brand-900 " />
 </div>
